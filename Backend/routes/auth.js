...
router.get("/currentUser", [authJwt.verifyToken], auth_controller.getUser);

// route for updating user profile
router.put("/updateProfile", [authJwt.verifyToken, auth_controller.updateUser]);
